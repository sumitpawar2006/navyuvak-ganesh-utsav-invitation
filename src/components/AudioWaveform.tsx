...
export default function AudioWaveform({ isRecording }: AudioWaveformProps) {
  ...
  return (
    <div className="listening-indicator" role="status" aria-label="Microphone is listening for your name">
      ...
      <span className="listening-copy"><strong>Listening now</strong><small>Speak your full name clearly</small></span>
    </div>
  );
}
